...
var hero_home_component_1 = require("./hero-home.component");
var hero_card_component_1 = require("./hero-card.component");
var heroRoutes = [
    {
        path: '',
        component: hero_home_component_1.HeroHomeComponent,
        children: [
            { path: '', redirectTo: 'heroes' },
            { path: 'heroes', component: hero_component_1.HeroComponent },
            { path: 'card/:id', component: hero_card_component_1.HeroCardComponent },
        ]
    }
];
